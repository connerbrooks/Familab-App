...
public class EventsFragment extends ListFragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        //Get calendar Events Asyncronusly
        try{
            getItemList();
    ...
    public void getItemList() throws JSONException {
        ...
        CalendarClient.get("AIzaSyA-gmdGWLc1hoe-kNO2_3rC20GVlWw2eY4", null, new JsonHttpResponseHandler() {
    ...
    private class CalendarListAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if(items.get(position).start.dateTime != null && !(items.get(position).start.dateTime.isEmpty())){
                startTime = items.get(position).start.dateTime;
            }
            if(items.get(position).end.dateTime != null && !((items.get(position).end.dateTime).isEmpty())){
                endTime = items.get(position).end.dateTime;
            }
            ...
            holder.primaryTouchTargetView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    String calUrl = items.get(mPosition).htmlLink;
