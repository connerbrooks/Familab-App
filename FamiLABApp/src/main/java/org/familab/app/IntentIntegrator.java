...
public class IntentIntegrator {
  ...
  public IntentIntegrator(Fragment activity) {
  ...
  private AlertDialog showDownloadDialog() {
    AlertDialog.Builder downloadDialog = new AlertDialog.Builder(activity.getActivity());
   ...
   *  else an {@link org.familab.app.IntentResult} containing the result of the scan. If the user cancelled scanning,
